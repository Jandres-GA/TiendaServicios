    ...
    public class LibrosServiceTest
    {
        private IEnumerable<LibreriaMaterial> ObtenerDataPrueba()
        {
            A.Configure<LibreriaMaterial>()
                ...
                .Fill(x => x.LibreraMateriaId, () => { return Guid.NewGuid(); });

            var lista = A.ListOf<LibreriaMaterial>(30);
            lista[0].LibreraMateriaId = Guid.Empty;
        ...
        public async void GetLibroPorId()
        {
            ...
            Assert.True(libro.LibreraMateriaId == Guid.Empty);
        ...
        public async void GetLibros()
        {
            ...
            // 3. Instanciar a la clase Manejador y pasarle como parametro los mocks que he creado
